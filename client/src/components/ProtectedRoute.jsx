...
const ProtectedRoute = ({ children, allowedUserType }) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-black-600 border-t-transparent rounded-full animate-spin mx-auto"></div>
  ...
  if (allowedUserType && user?.userType !== allowedUserType) {
    console.log(
      `User type ${user?.userType} doesn't match required ${allowedUserType}`,
    );
